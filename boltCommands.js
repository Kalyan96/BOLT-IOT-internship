...
function analogWrite(pin,val) {
    ...
    xmlhttp.open("GET","http://cloud.boltiot.com/remote/"+api_key+"/analogWrite?pin="+pin+"&value="+val+"&deviceName="+d_name,true);
    xmlhttp.send();
}   
...
function serialBegin(baud) {
    ...
    xmlhttp.open("GET","http://cloud.boltiot.com/remote/"+api_key+"/serialBegin?baud="+baud+"&deviceName="+d_name,true);
    xmlhttp.send();
}
...
function serialWrite(serialdata) {
    ...
    xmlhttp.open("GET","http://cloud.boltiot.com/remote/"+api_key+"/serialWrite?data="+serialdata+"&deviceName="+d_name,true);
    xmlhttp.send();
}
...
function serialRead(till,element_id) {
    ...
    xmlhttp.open("GET","http://cloud.boltiot.com/remote/"+api_key+"/serialRead?till="+till+"&deviceName="+d_name,true);
    xmlhttp.send();
}
...
function serialWR(data,till,element_id) {
    ...
    xmlhttp.open("GET","http://cloud.boltiot.com/remote/"+api_key+"/serialWR?data="+data+"&till="+till+"&deviceName="+d_name,true);
    xmlhttp.send();
}
...
function digitalMultiWrite(pins,values) {
    ...
    xmlhttp.open("GET","http://cloud.boltiot.com/remote/"+api_key+"/digitalMultiWrite?pins="+pins+"&states="+values+"&deviceName="+d_name,true);
    xmlhttp.send();
}
...
function analogMultiWrite(pins,values) {
    ...
    xmlhttp.open("GET","http://cloud.boltiot.com/remote/"+api_key+"/analogMultiWrite?pins="+pins+"&values="+values+"&deviceName="+d_name,true);
    xmlhttp.send();
}
...
function digitalMultiRead(pins,element_id) {
    ...
    xmlhttp.open("GET","http://cloud.boltiot.com/remote/"+api_key+"/digitalMultiRead?pins="+pins+"&deviceName="+d_name,true);
    xmlhttp.send();
}
